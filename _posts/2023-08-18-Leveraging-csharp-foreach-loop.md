...
> The enumerator should always be a struct (a value-type) for improved performance! Check my other article "[Performance of value-type vs reference-type enumerators in C#](/posts/Value-type-vs-reference-type-enumerables/)" to understand why.
